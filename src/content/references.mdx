...
- The  menu on the left side of the `dashboard` containing the <Icon type='game' />, <Icon type='cards' />, <Icon type='award' />, <Icon type='hourglass' />, <Icon type='heart' />, <Icon type='gift' />, <Icon type='cog' /> and <Icon type='signout' /> buttons
...
- Represents a game in the user's Steam library `games list`. Contains a banner image of the Steam game, and the <Icon type='play' />, <Icon type='award' /> and <Icon type='dots' /> buttons
...
- The external windows that are opened when a game is idled, that contain a banner image and title of the Steam game that is being idled
