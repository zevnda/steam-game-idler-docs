...
* **Purpose:** Delete local data such as `steam credentials`, `favorites list`, `card farming list`, and `achievement unlocker list`, when logging out of SGI using the `logout` button
