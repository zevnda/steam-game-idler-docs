...
<References page='/features/card-farming'>
    ...
    * **[Card Farming List](/features/card-farming#card-farming-list):** Use a custom list of games you want to farm cards for
    * **[All Games With Drops](/features/card-farming#all-games-with-drops):** Farm cards for all games in your Steam library that have card drops remaining
    ...
    <Steps>
        ...
        {<h3 />}
        Click <MockButton type='card-farming' /> to start Card Farming
    </Steps>
