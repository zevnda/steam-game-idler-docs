...
<Callout type="info">
    Before you can use the Card Farming feature, you will need to provide your [Steam credentials](/steam-credentials) in [Settings > Card Farming](/settings/card-farming).
</Callout>
...
{<h3>Step 4</h3>}
Click on the `add to card farming` option
...
You can view the games that are currently in your `card farming list` by selecting `card farming` from the `drop-down sort menu` at the top of the `games list`.
